...
(** [place_bet bet game] is an updated [game] where the current non-dealer
    player places [bet], incrementing the current player. Requires: [game] is
    not currently running; all players that will be added to [game] have already
...
(* [TODO]: get_players function to get list of all players in game -> Used for
   testing suite *)
